...
public class RegistrationIntegrationTest {
    ...
    public void registrationUserFail_With_MismatchedPasswords_And_Return_RegistrationPage_Test() throws Exception {
        this.mockMvc.perform(post("/registration")
                ...
                .andExpect(content().contentType("text/html;charSet = UTF-8"))
                .andExpect(model().errorCount(1))
                .andExpect(model().attributeHasFieldErrors("user", "verifyPassword"))
                .andExpect(view().name("registration"));
    }
    ...
    @Test
    public void registrationUserFail_With_LoginLessThan3Word_And_Return_RegistrationPage_Test() throws Exception {
        this.mockMvc.perform(post("/registration")
                .param("login", "M")
                .param("password", "111111")
                .param("verifyPassword", "111111"))
